...
export HADOOP_HOME="/home/ubuntu/teaa/cluster/hadoop" # ADDED BY Jon Ander Gomez FOR TEAA
...
#
export HADOOP_CONF_DIR=${HADOOP_HOME}/etc/hadoop # UNCOMMENTED BY Jon Ander Gomez FOR TEAA
...
export HADOOP_HEAPSIZE_MAX=1500 # ADDED BY Jon Ander Gomez FOR TEAA
...
# Uncomment the next line if you experience errors concerning Java libraries for Hadoop
export HADOOP_OPTS="$HADOOP_OPTS -Djava.library.path=$HADOOP_HOME/lib/native" #  ADDED BY Jon Ander Gomez FOR TEAA
